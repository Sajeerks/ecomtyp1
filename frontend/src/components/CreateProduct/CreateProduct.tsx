...
import { createSingleNewProduct, resetSingleProductReducer } from '../../redux/reducers/singleProductReducer';
...
console.log("submitted the product");
      },
    });
...
console.log(formik);
  ...
  // const [themodalImage, setthemodalImage] = useState("")
  const [modalIndex, setmodalIndex] = useState(0)

  const ImageModler =(event:React.MouseEvent)=>(imageUrl:string, index:number)=>{
...
apiKey='0oc6cviwzuenmvc7cenc4jun2n8rjrkqpqyc6yudnkuim9zc'
         ...
         initialValue="<p>Please enter a valid product description not less than 50 characters </p>"
         init={{
           height: 200,
           menubar: false,
...
{(open && imageArray &&  imageArray?.length>0)  && <Modal
      ...
      sx={{background:themer.palette.common.white, width:"100vw",height:"100vh", display:"flex"
